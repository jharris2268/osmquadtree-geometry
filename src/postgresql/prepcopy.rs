use osmquadtree::elements::{Quadtree, Tag, WithId, WithQuadtree, WithTags};
use crate::postgresql::{ColumnSource, ColumnType, GeosGeometry, TableSpec};
...
fn write_uint16_be<W: Write>(w: &mut W, i: usize) -> Result<()> {
    w.write_all(&[((i >> 8) & 255) as u8, (i & 255) as u8])
}

fn write_int32_be<W: Write>(w: &mut W, i: i32) -> Result<()> {
    write_uint32_be(w, i as u32)
}

fn write_int64_be<W: Write>(w: &mut W, i: i64) -> Result<()> {
    write_uint64_be(w, i as u64)
}

fn write_uint32_be<W: Write>(w: &mut W, i: u32) -> Result<()> {
    w.write_all(&[
        ((i >> 24) & 255) as u8,
        ((i >> 16) & 255) as u8,
        ((i >> 8) & 255) as u8,
...
fn write_uint64_be<W: Write>(w: &mut W, i: u64) -> Result<()> {
    w.write_all(&[
        ((i >> 56) & 255) as u8,
        ((i >> 48) & 255) as u8,
        ((i >> 40) & 255) as u8,
...
fn write_f64_be<W: Write>(w: &mut W, f: f64) -> Result<()> {
